...
def trading():
    ...
    # Checking orders and making predictions is only necessary if there have been activity in the stock since last time
    ...
    for ticker in tickers:
        ...
        prediction_low, prediction_high = broker.round_prediction_to_tick_size(prediction_next_period)
        predictions.append(
            StockPrediction(
                ticker,
                prediction_low,
